...
- Exceptions generated when executing `find_file` will be wrapped with a `Sprockets::LoadError` exception. To get original exception call `Sprockets::LoadError#cause`.
